...
//webpage to grab multiple random images from the server
app.get("/multiple", (req, res) => {
  res.sendFile(path.join(__dirname, "views", "multiple.html"));
});

// This route will grab the multiple photos for the webpage from the uploads
app.get("/fetch-multiple", (req, res) => {
  ...
  //Grab all items from the upload folder
...
//showcases all images from the server
